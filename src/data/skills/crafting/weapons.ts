...
export const weapons: Resource[] = [
  ...
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 18, attackSpeed: 2400, critChance: 0.05, critMulti: 1.5 },
    category: "sword",
    combatStyle: "melee",
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 30, attackSpeed: 2500, critChance: 0.08, critMulti: 1.6 },
    category: "sword",
    combatStyle: "melee",
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 50, attackSpeed: 2200, critChance: 0.1, critMulti: 1.7 }, // Nopeampi ja critimpi
    category: "sword",
    combatStyle: "melee",
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 80, attackSpeed: 2400, critChance: 0.12, critMulti: 1.8 },
    category: "sword",
    combatStyle: "melee",
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 120, attackSpeed: 2300, critChance: 0.15, critMulti: 2.0 },
    category: "sword",
    combatStyle: "melee",
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 180, attackSpeed: 2000, critChance: 0.2, critMulti: 2.2 }, // Tosi nopea huippuase
    category: "sword",
    combatStyle: "melee",
  },
  {
    ...
    slot: "weapon",
    stats: { attack: 250, attackSpeed: 2400, critChance: 0.25, critMulti: 2.5 },
    category: "sword",
    combatStyle: "melee",
  },
  {
  ...
  },
  {
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 14, attackSpeed: 3000, critChance: 0.12, critMulti: 2.0 },
    category: "bow",
  },
  {
    id: "bow_gold",
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 22, attackSpeed: 3200, critChance: 0.15, critMulti: 2.2 },
    category: "bow",
  },
  {
    id: "bow_mithril",
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 35, attackSpeed: 2800, critChance: 0.18, critMulti: 2.3 },
    category: "bow",
  },
  {
    id: "bow_adamantite",
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 50, attackSpeed: 3000, critChance: 0.2, critMulti: 2.5 },
    category: "bow",
  },
  {
    id: "bow_emerald",
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 70, attackSpeed: 2800, critChance: 0.25, critMulti: 2.8 },
    category: "bow",
  },
  {
    id: "bow_eternium",
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 95, attackSpeed: 2500, critChance: 0.3, critMulti: 3.0 },
    category: "bow",
  },
  {
    id: "bow_starfall",
    ...
    slot: "weapon",
    combatStyle: "ranged",
    stats: { attack: 130, attackSpeed: 3000, critChance: 0.35, critMulti: 3.5 },
    category: "bow",
  },
  ...
  },
  {
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 12, attackSpeed: 2600, critChance: 0.05, critMulti: 1.5 },
    category: "staff",
  },
  {
    id: "staff_gold",
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 20, attackSpeed: 2600, critChance: 0.06, critMulti: 1.6 },
    category: "staff",
  },
  {
    id: "staff_mithril",
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 32, attackSpeed: 2400, critChance: 0.08, critMulti: 1.7 },
    category: "staff",
  },
  {
    id: "staff_adamantite",
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 48, attackSpeed: 2600, critChance: 0.1, critMulti: 1.8 },
    category: "staff",
  },
  {
    id: "staff_emerald",
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 65, attackSpeed: 2500, critChance: 0.12, critMulti: 2.0 },
    category: "staff",
  },
  {
    id: "staff_eternium",
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 90, attackSpeed: 2200, critChance: 0.15, critMulti: 2.2 },
    category: "staff",
  },
  {
    id: "staff_starfall",
    ...
    slot: "weapon",
    combatStyle: "magic",
    stats: { attack: 125, attackSpeed: 2400, critChance: 0.2, critMulti: 2.5 },
    category: "staff",
  },
];
