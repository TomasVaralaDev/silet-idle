...
export default function RewardModal() {
  ...
  const getRarityColor = (rarity: Rarity | undefined) => {
    switch (rarity) {
      case "legendary":
        return "border-amber-500 bg-amber-500/10 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)]";
      case "epic":
        return "border-purple-500 bg-purple-500/10 text-purple-400 shadow-[0_0_15px_rgba(168,85,247,0.3)]";
      case "rare":
        return "border-blue-500 bg-blue-500/10 text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.3)]";
      case "uncommon":
