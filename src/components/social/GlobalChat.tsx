      ...
      >
        <div className="relative flex items-center">
          <input
            ...
            /* KORJAUS: 'uppercase' poistettu alta */
            className="w-full bg-app-base/50 border border-border rounded-sm px-3 py-2 text-sm text-tx-main focus:outline-none focus:border-accent/50 disabled:opacity-50 transition-all placeholder:text-tx-muted/20 placeholder:normal-case font-bold tracking-wider"
          />
          <button
            type="submit"
