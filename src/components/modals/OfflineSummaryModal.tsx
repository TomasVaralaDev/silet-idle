            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {Object.entries(results.xpGained).map(([skill, amount]) => (
                  <div
                    key={skill}
                    className="bg-slate-800/50 p-2 rounded flex justify-between items-center border border-slate-700/50"
                  >
              ...
              <div className="space-y-2">
                {Object.entries(results.itemsGained).map(([itemId, count]) => {
                  ...
                  return (
                    <div
                      key={itemId}
                      className="flex items-center gap-3 bg-slate-800/50 p-2 rounded border border-slate-700/50"
                    >
