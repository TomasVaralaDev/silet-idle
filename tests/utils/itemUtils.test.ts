...
describe('Inventory & Item Utilities', () => {
  ...
  describe('getPlayerStats Calculation', () => {
    ...
    it('should calculate base HP correctly (Level * 10)', () => {
      const stats = getPlayerStats(mockSkills, 'melee', { damage: 0, armor: 0 });
    ...
    it('should calculate mainStat correctly (Attack level + Combat style level)', () => {
      const stats = getPlayerStats(mockSkills, 'melee', { damage: 1, armor: 0 });
