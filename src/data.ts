...
export const GAME_DATA: Record<string, Resource[]> = {
  ...
  smithing: [
    ...
    { id: 'shield_copper', name: 'Copper Shield', levelRequired: 5, xpReward: 25, interval: 3500, value: 60, icon: '/assets/items/shields/shield_copper.png', color: 'text-orange-400', description: 'A basic defensive buckler.', inputs: [{ id: 'ore_copper_smelted', count: 3 }], slot: 'shield', stats: { defense: 8 }, category: 'shields' },
    { id: 'shield_iron', name: 'Iron Shield', levelRequired: 15, xpReward: 45, interval: 4500, value: 150, icon: '/assets/items/shields/shield_iron.png', color: 'text-slate-400', description: 'Standard infantry shield.', inputs: [{ id: 'ore_iron_smelted', count: 3 }], slot: 'shield', stats: { defense: 18 }, category: 'shields' },
    { id: 'shield_gold', name: 'Gold Shield', levelRequired: 25, xpReward: 70, interval: 5500, value: 350, icon: '/assets/items/shields/shield_gold.png', color: 'text-yellow-400', description: 'Heavy and ceremonial.', inputs: [{ id: 'ore_gold_smelted', count: 3 }], slot: 'shield', stats: { defense: 28 }, category: 'shields' },
    { id: 'shield_mithril', name: 'Mithril Shield', levelRequired: 40, xpReward: 100, interval: 6500, value: 900, icon: '/assets/items/shields/shield_mithril.png', color: 'text-blue-300', description: 'Lightweight elven metal.', inputs: [{ id: 'ore_mithril_smelted', count: 3 }], slot: 'shield', stats: { defense: 42, attack: 2 }, category: 'shields' },
    { id: 'shield_adamantite', name: 'Adamantite Shield', levelRequired: 55, xpReward: 140, interval: 8000, value: 2000, icon: '/assets/items/shields/shield_adamantite.png', color: 'text-purple-400', description: 'Impenetrable alloy plating.', inputs: [{ id: 'ore_adamantite_smelted', count: 3 }], slot: 'shield', stats: { defense: 60, attack: 4 }, category: 'shields' },
    { id: 'shield_emerald', name: 'Emerald Shield', levelRequired: 70, xpReward: 200, interval: 10000, value: 4000, icon: '/assets/items/shields/shield_emerald.png', color: 'text-emerald-400', description: 'Radiates protective energy.', inputs: [{ id: 'ore_emerald_smelted', count: 3 }], slot: 'shield', stats: { defense: 85, attack: 6 }, category: 'shields' },
    { id: 'shield_eternium', name: 'Eternium Shield', levelRequired: 85, xpReward: 300, interval: 13000, value: 7500, icon: '/assets/items/shields/shield_eternium.png', color: 'text-red-500', description: 'Forged in dragonfire.', inputs: [{ id: 'ore_eternium_smelted', count: 3 }], slot: 'shield', stats: { defense: 110, attack: 10 }, category: 'shields' },
    { id: 'shield_starfall', name: 'Starfall Shield', levelRequired: 99, xpReward: 500, interval: 18000, value: 15000, icon: '/assets/items/shields/shield_starfall.png', color: 'text-indigo-400', description: 'Deflects the cosmos itself.', inputs: [{ id: 'ore_starfallalloy_smelted', count: 3 }], slot: 'shield', stats: { defense: 150, attack: 20 }, category: 'shields' },
  ],
  ...
  crafting: [
    ...
    // --- BOWS (RANGED WEAPONS) ---
    { id: 'bow_copper', name: 'Copper Bow', levelRequired: 1, xpReward: 25, interval: 2500, value: 40, icon: '/assets/items/bows/bow_copper.png', color: 'text-orange-400', description: 'A flexible copper-reinforced bow.', inputs: [{ id: 'pine_plank', count: 3 }, { id: 'ore_copper_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 6 }, category: 'bows' },
    { id: 'bow_iron', name: 'Iron Bow', levelRequired: 10, xpReward: 50, interval: 3000, value: 100, icon: '/assets/items/bows/bow_iron.png', color: 'text-slate-400', description: 'Sturdy iron-limbed bow.', inputs: [{ id: 'oak_plank', count: 3 }, { id: 'ore_iron_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 14 }, category: 'bows' },
    { id: 'bow_gold', name: 'Gold Bow', levelRequired: 25, xpReward: 90, interval: 3500, value: 250, icon: '/assets/items/bows/bow_gold.png', color: 'text-yellow-400', description: 'Heavy draw weight, high impact.', inputs: [{ id: 'willow_plank', count: 3 }, { id: 'ore_gold_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 22 }, category: 'bows' },
    { id: 'bow_mithril', name: 'Mithril Bow', levelRequired: 40, xpReward: 150, interval: 4000, value: 600, icon: '/assets/items/bows/bow_mithril.png', color: 'text-blue-300', description: 'Lightweight and deadly accurate.', inputs: [{ id: 'yew_plank', count: 3 }, { id: 'ore_mithril_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 35 }, category: 'bows' },
    { id: 'bow_adamantite', name: 'Adamantite Bow', levelRequired: 55, xpReward: 250, interval: 5000, value: 1500, icon: '/assets/items/bows/bow_adamantite.png', color: 'text-purple-400', description: 'Powerful compound construction.', inputs: [{ id: 'sunwood_plank', count: 3 }, { id: 'ore_adamantite_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 50 }, category: 'bows' },
    { id: 'bow_emerald', name: 'Emerald Bow', levelRequired: 70, xpReward: 400, interval: 6000, value: 3000, icon: '/assets/items/bows/bow_emerald.png', color: 'text-emerald-400', description: 'Infused with nature energy.', inputs: [{ id: 'frostbark_plank', count: 3 }, { id: 'ore_emerald_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 70 }, category: 'bows' },
    { id: 'bow_eternium', name: 'Eternium Bow', levelRequired: 85, xpReward: 650, interval: 7500, value: 6000, icon: '/assets/items/bows/bow_eternium.png', color: 'text-red-500', description: 'Fires arrows at supersonic speeds.', inputs: [{ id: 'bloodwood_plank', count: 3 }, { id: 'ore_eternium_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 95 }, category: 'bows' },
    { id: 'bow_starfall', name: 'Starfall Bow', levelRequired: 99, xpReward: 1000, interval: 10000, value: 15000, icon: '/assets/items/bows/bow_starfall.png', color: 'text-indigo-400', description: 'Forged from starlight itself.', inputs: [{ id: 'heartwood_plank', count: 3 }, { id: 'ore_starfallalloy_smelted', count: 1 }], slot: 'weapon', combatStyle: 'ranged', stats: { attack: 130 }, category: 'bows' },
  
    // --- STAFFS (MAGIC WEAPONS) ---
    { id: 'staff_copper', name: 'Copper Staff', levelRequired: 1, xpReward: 25, interval: 2500, value: 45, icon: '/assets/items/staffs/staff_copper.png', color: 'text-orange-400', description: 'Channels basic magical energy.', inputs: [{ id: 'pine_plank', count: 3 }, { id: 'ore_copper_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 5 }, category: 'staffs' },
    { id: 'staff_iron', name: 'Iron Staff', levelRequired: 10, xpReward: 50, interval: 3000, value: 110, icon: '/assets/items/staffs/staff_iron.png', color: 'text-slate-400', description: 'A sturdy focus for spellcasting.', inputs: [{ id: 'oak_plank', count: 3 }, { id: 'ore_iron_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 12 }, category: 'staffs' },
    { id: 'staff_gold', name: 'Gold Staff', levelRequired: 25, xpReward: 90, interval: 3500, value: 280, icon: '/assets/items/staffs/staff_gold.png', color: 'text-yellow-400', description: 'Highly conductive to mana.', inputs: [{ id: 'willow_plank', count: 3 }, { id: 'ore_gold_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 20 }, category: 'staffs' },
    { id: 'staff_mithril', name: 'Mithril Staff', levelRequired: 40, xpReward: 150, interval: 4000, value: 650, icon: '/assets/items/staffs/staff_mithril.png', color: 'text-blue-300', description: 'Lightweight and powerful.', inputs: [{ id: 'yew_plank', count: 3 }, { id: 'ore_mithril_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 32 }, category: 'staffs' },
    { id: 'staff_adamantite', name: 'Adamantite Staff', levelRequired: 55, xpReward: 250, interval: 5000, value: 1600, icon: '/assets/items/staffs/staff_adamantite.png', color: 'text-purple-400', description: 'Amplifies spells significantly.', inputs: [{ id: 'sunwood_plank', count: 3 }, { id: 'ore_adamantite_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 48 }, category: 'staffs' },
    { id: 'staff_emerald', name: 'Emerald Staff', levelRequired: 70, xpReward: 400, interval: 6000, value: 3200, icon: '/assets/items/staffs/staff_emerald.png', color: 'text-emerald-400', description: 'Pulsates with nature magic.', inputs: [{ id: 'frostbark_plank', count: 3 }, { id: 'ore_emerald_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 65 }, category: 'staffs' },
    { id: 'staff_eternium', name: 'Eternium Staff', levelRequired: 85, xpReward: 650, interval: 7500, value: 6200, icon: '/assets/items/staffs/staff_eternium.png', color: 'text-red-500', description: 'Forged from dragonfire and magic.', inputs: [{ id: 'bloodwood_plank', count: 3 }, { id: 'ore_eternium_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 90 }, category: 'staffs' },
    { id: 'staff_starfall', name: 'Starfall Staff', levelRequired: 99, xpReward: 1000, interval: 10000, value: 15500, icon: '/assets/items/staffs/staff_starfall.png', color: 'text-indigo-400', description: 'Controls the fabric of the cosmos.', inputs: [{ id: 'heartwood_plank', count: 3 }, { id: 'ore_starfallalloy_smelted', count: 1 }], slot: 'weapon', combatStyle: 'magic', stats: { attack: 125 }, category: 'staffs' },
  ],
