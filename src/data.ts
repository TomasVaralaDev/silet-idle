...
export const GAME_DATA: Record<string, Resource[]> = {
  ...
  crafting: [
    ...
    { id: 'weapon_sword_bronze', name: 'Bronze Sword', levelRequired: 1, xpReward: 20, interval: 3000, value: 15, icon: '/assets/items/aseet/weapon_sword_bronze.png', color: 'text-orange-600', description: 'Basic sword.', inputs: [{ id: 'ore_copper_smelted', count: 2 }], slot: 'weapon', stats: { attack: 8 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_iron', name: 'Iron Sword', levelRequired: 15, xpReward: 50, interval: 5000, value: 50, icon: '/assets/items/aseet/weapon_sword_iron.png', color: 'text-slate-400', description: 'Sharp and reliable.', inputs: [{ id: 'ore_iron_smelted', count: 3 }], slot: 'weapon', stats: { attack: 18 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_gold', name: 'Gold Sword', levelRequired: 25, xpReward: 70, interval: 6500, value: 120, icon: '/assets/items/aseet/weapon_sword_gold.png', color: 'text-yellow-400', description: 'Shiny and heavy.', inputs: [{ id: 'ore_gold_smelted', count: 3 }], slot: 'weapon', stats: { attack: 30 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_mithril', name: 'Mithril Sword', levelRequired: 40, xpReward: 100, interval: 8000, value: 250, icon: '/assets/items/aseet/weapon_sword_mithril.png', color: 'text-cyan-400', description: 'Lightweight blade.', inputs: [{ id: 'ore_mithril_smelted', count: 3 }], slot: 'weapon', stats: { attack: 50 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_adamantite', name: 'Adamantite Sword', levelRequired: 55, xpReward: 150, interval: 9500, value: 500, icon: '/assets/items/aseet/weapon_sword_adamantite.png', color: 'text-purple-400', description: 'Extremely hard edge.', inputs: [{ id: 'ore_adamantite_smelted', count: 3 }], slot: 'weapon', stats: { attack: 80 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_emerald', name: 'Emerald Sword', levelRequired: 70, xpReward: 220, interval: 11000, value: 1000, icon: '/assets/items/aseet/weapon_sword_emerald.png', color: 'text-emerald-400', description: 'Crystalline power.', inputs: [{ id: 'ore_emerald_smelted', count: 3 }], slot: 'weapon', stats: { attack: 120 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_eternium', name: 'Eternium Sword', levelRequired: 85, xpReward: 350, interval: 13000, value: 2500, icon: '/assets/items/aseet/weapon_sword_eternium.png', color: 'text-red-500', description: 'Blade out of time.', inputs: [{ id: 'ore_eternium_smelted', count: 3 }], slot: 'weapon', stats: { attack: 180 }, category: 'weapons', combatStyle: 'melee' },
    { id: 'weapon_sword_starfallalloy', name: 'Starfall Sword', levelRequired: 99, xpReward: 500, interval: 16000, value: 5000, icon: '/assets/items/aseet/weapon_sword_starfallalloy.png', color: 'text-indigo-400', description: 'Cosmic destruction.', inputs: [{ id: 'ore_starfallalloy_smelted', count: 3 }], slot: 'weapon', stats: { attack: 250 }, category: 'weapons', combatStyle: 'melee' },
