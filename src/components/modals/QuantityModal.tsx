      ...
      <div className="bg-slate-800 border border-slate-600 p-6 rounded-xl w-full max-w-sm shadow-2xl relative animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              className="flex-1 bg-emerald-600 hover:bg-emerald-500 py-2 rounded font-bold text-white"
            >
              Confirm
            </button>
            <button
              type="button"
              onClick={onClose}
              className="flex-1 bg-slate-700 hover:bg-slate-600 py-2 rounded font-bold text-slate-300"
            >
              Cancel
            </button>
          </div>
