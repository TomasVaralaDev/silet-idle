...
export const WORLD_INFO: Record<
  number,
...
export const WORLD_LOOT: Record<number, WeightedDrop[]> = {
  ...
  3: [
    { itemId: "coins", weight: 2000, amount: [40, 70] },
  ...
  4: [
    { itemId: "coins", weight: 2000, amount: [60, 90] },
  ...
  5: [
    { itemId: "coins", weight: 2000, amount: [30, 120] },
  ...
  6: [
    { itemId: "coins", weight: 2000, amount: [80, 150] },
  ...
  7: [
    { itemId: "coins", weight: 2000, amount: [150, 300] },
  ...
  8: [
    { itemId: "coins", weight: 2000, amount: [250, 350] },
